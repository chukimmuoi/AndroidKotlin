 ...
 * Created by chukimmuoi on 4/9/17.
 */

/**
 * @see {https://github.com/pnikosis/materialish-progress}
 */
public class CircleProgress extends View {
    ...
    public CircleProgress(Context context, AttributeSet attrs) {
        ...
        parseAttributes(context.obtainStyledAttributes(attrs, R.styleable.CircleProgress));
    ...
    private void parseAttributes(TypedArray a) {
        ...
        circleRadius =
                (int) a.getDimension(R.styleable.CircleProgress_matProg_circleRadius, circleRadius);

        fillRadius = a.getBoolean(R.styleable.CircleProgress_matProg_fillRadius, false);

        barWidth = (int) a.getDimension(R.styleable.CircleProgress_matProg_barWidth, barWidth);

        rimWidth = (int) a.getDimension(R.styleable.CircleProgress_matProg_rimWidth, rimWidth);

        float baseSpinSpeed =
                a.getFloat(R.styleable.CircleProgress_matProg_spinSpeed, spinSpeed / 360.0f);
        spinSpeed = baseSpinSpeed * 360;

        barSpinCycleTime =
                a.getInt(R.styleable.CircleProgress_matProg_barSpinCycleTime, (int) barSpinCycleTime);

        barColor = a.getColor(R.styleable.CircleProgress_matProg_barColor, barColor);

        rimColor = a.getColor(R.styleable.CircleProgress_matProg_rimColor, rimColor);

        linearProgress = a.getBoolean(R.styleable.CircleProgress_matProg_linearProgress, false);

        if (a.getBoolean(R.styleable.CircleProgress_matProg_progressIndeterminate, false)) {
            spin();
        }
